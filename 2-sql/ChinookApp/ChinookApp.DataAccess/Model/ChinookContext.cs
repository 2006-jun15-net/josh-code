...
namespace ChinookApp.DataAccess.Model
{
    public partial class ChinookContext : DbContext
    {
        ...
        public virtual DbSet<Exdepartment> Exdepartment { get; set; }
        public virtual DbSet<ExempDetails> ExempDetails { get; set; }
        public virtual DbSet<Exemployee> Exemployee { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Exdepartment>(entity =>
            {
                entity.ToTable("EXDepartment");
            ...
            modelBuilder.Entity<ExempDetails>(entity =>
            {
                entity.ToTable("EXEmpDetails");
                ...
                entity.HasOne(d => d.Employee)
                    .WithMany(p => p.ExempDetails)
                    .HasForeignKey(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__EXEmpDeta__Count__01142BA1");
            });

            modelBuilder.Entity<Exemployee>(entity =>
            {
                entity.ToTable("EXEmployee");
                ...
                entity.HasOne(d => d.Dept)
                    .WithMany(p => p.Exemployee)
                    .HasForeignKey(d => d.DeptId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__EXEmploye__DeptI__7E37BEF6");
            });
